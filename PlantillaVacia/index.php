    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3 style="color: white;">Pagina principal</h3>
            </div>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Registros</h6>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Sanciones</h6>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Armas</h6>
                                                <h6 class="font-extrabold mb-0">112</h6>
                                            </div>
                                        </div>
                                    </div>
